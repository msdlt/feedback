...
<?php
	if(IsAuthor($heraldID))
		...
		echo "<a href=\"results.php\">Results</a> &gt; Delete Results"; 	
...
if(isset($_POST['bChooseSurveys']))
	...
	<form id=\"frmAnalyse\" name=\"frmAnalyse\" action=\"showdeletestudents.php\" method=\"post\" onSubmit=\"return ValidateSecondForm()\">";
	...
	echo "	<h2>Step 3: Generate Results</h2>
			<input type=\"submit\" value=\"Show students\" id=\"bShowStudents\" name=\"bShowStudents\">	";
	echo "</form>
		</div>";
...
<?php
	...
	require_once("includes/instructions/inst_deletestudents.php"); 
?>
</body>
</html>
