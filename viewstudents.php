...
function OnbShowStudents()
	...
	if(ValidateSecondForm()==false)
		...
		{
		document.frmAnalyse.action = "showstudents.php"
...
<?php
	if(IsAuthor($heraldID))
		...
		echo "<a href=\"results.php\">Results</a> &gt; View Students"; 	
...
if(isset($_POST['bChooseSurveys']))
	...
	echo "	<h2>Step 3: Generate Results</h2>
			<input type=\"submit\" value=\"Show students\" id=\"bShowStudents\" name=\"bShowStudents\" onClick=\"return OnbShowStudents();\">";
	echo "</form>
		</div>";
